...
- Client screenshot: a saved board with connected elements ("Changes saved.").

  ![Lab 5 client: a saved board with connected rectangles and text](docs/evidence/lab5-capture.png)
